...
export default function App() {
    ...
    return (_jsxs("div", { style: { background: "var(--bg)", minHeight: "100vh", position: "relative" }, children: [_jsx("div", { className: "grid-bg" }), _jsx("div", { className: "noise-overlay" }), _jsx(motion.div, { className: "glow-orb-cyan", style: {
                    ...
                    gap: 20,
                }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10, flexShrink: 0 }, children: [_jsx("img", { src: "/logo.png", alt: "Miles Trader", style: {
                                    width: 32, height: 32, borderRadius: 7,
                                    objectFit: "contain",
                                    flexShrink: 0,
                                } }), _jsx("div", { style: { display: "flex", alignItems: "baseline", gap: 6 }, children: _jsx("span", { style: { fontSize: 13, fontWeight: 700, letterSpacing: "-0.02em", color: "var(--text)" }, children: "MILES TRADER" }) })] }), _jsx("nav", { style: { display: "flex", gap: 2, overflow: "auto" }, children: TABS.map((tab) => (_jsx("button", { className: `tab-btn${activeTab === tab.id ? " active" : ""}`, onClick: () => setActiveTab(tab.id), children: tab.label }, tab.id))) }), _jsxs("div", { style: { display: "flex", alignItems: "center", gap: 16, flexShrink: 0 }, children: [_jsx("a", { href: "https://github.com/JunaidAtta-ai/Miles_Trader", target: "_blank", rel: "noreferrer", title: "GitHub", style: { display: "flex", alignItems: "center", opacity: 0.45, transition: "opacity 0.15s", color: "var(--text)" }, onMouseEnter: e => (e.currentTarget.style.opacity = "1"), onMouseLeave: e => (e.currentTarget.style.opacity = "0.45"), children: _jsx("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "currentColor", children: _jsx("path", { d: "M12 2C6.477 2 2 6.477 2 12c0 4.418 2.865 8.166 6.839 9.489.5.092.682-.217.682-.482 0-.237-.009-.868-.013-1.703-2.782.604-3.369-1.342-3.369-1.342-.454-1.155-1.11-1.463-1.11-1.463-.908-.62.069-.608.069-.608 1.003.07 1.531 1.03 1.531 1.03.892 1.529 2.341 1.087 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.269 2.75 1.025A9.578 9.578 0 0 1 12 6.836a9.59 9.59 0 0 1 2.504.337c1.909-1.294 2.747-1.025 2.747-1.025.546 1.377.202 2.394.1 2.647.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.935.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.743 0 .267.18.578.688.48C19.138 20.163 22 16.418 22 12c0-5.523-4.477-10-10-10z" }) }) }), _jsxs("div", { style: {
